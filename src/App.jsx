      ...
      >
        ...
        {!isSidebarCollapsed && (
          isEditing ? (
            ...
            <>
              <span 
                className={`truncate flex-1 min-w-0 md:pr-0 ${isSelected ? "pr-[88px]" : "pr-2"}`} 
                title={category.name}
              >
                {category.name}
              </span>
              ...
              <div 
                className={`absolute right-2 flex gap-1 transition-opacity bg-background-paper p-1 rounded-md shadow-sm border border-border z-10
                  ${isSelected ? "opacity-100" : "opacity-0"} md:opacity-0 md:group-hover/cat:opacity-100
                `}
              >
                <button
                  onClick={(e) => {
